...
namespace BusinessDirectory.Data.Migrations
{
    ...
    [Migration("20220316144543_Deleted UserWishList")]
    partial class DeletedUserWishList
    {
            ...
            modelBuilder.Entity("BusinessDirectory.DB.Models.Service", b =>
                {
                    ...
                    b.HasOne("BusinessDirectory.DB.Models.Review", null)
                        .WithOne("Service")
                        .HasForeignKey("BusinessDirectory.DB.Models.Service", "ReviewID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
